<?php
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM venda_cancelada WHERE id LIKE '%$data%' or data_pedido LIKE '%$data%'  OR nome LIKE '%$data%' OR nome LIKE '%$data%'  ORDER BY id DESC";

    }
    else
    {
        $sql = "SELECT * FROM venda_cancelada  ORDER BY id DESC";
    }
