<?php
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM venda_finalizada WHERE id LIKE '%$data%' or data_pedido LIKE '%$data%'  OR nome LIKE '%$data%' OR nome LIKE '%$data%' and status='F'  ORDER BY id DESC";

    }
    else
    {
        $sql = "SELECT * FROM venda_finalizada where status='F' ORDER BY id DESC";
    }
...
<body>
    ...
    <br>
    <?php
        echo "<h4>Bem vindo a INFORMAÇÕES DE VENDAS </h4>
            ...
            <tbody>
                <?php
                    while($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>
                        <a class='btn btn-sm btn-primary' href='vendaDetalhe.php?id=$user_data[id]' title='Visualizar'>
