...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="principal.php">PAGINA PRINCIPAL</a>
    ...
    <br>
    <div class="d-flex">
            <a href="caPesquisa.php" class="button">+Voltar</a>
        </div>
        <br>
    <div class="m-5">
            ...
            <tbody>
                <?php
                    while($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>".$user_data['NOME_FUNCAO']."</td>";
...
<script>
    ...
    function searchData()
    {
        window.location = 'caView.php?search='+search.value;
    }
</script>
</html>