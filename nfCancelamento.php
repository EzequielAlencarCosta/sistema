...
<body>
    ...
    <br>
    <?php
        echo "<h4> CANCELAR NOTAS EMITIDAS </h4>
            ...
            <tbody>
                <?php
                    while($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>
                        <a class='btn btn-sm btn-primary' href='notaCancelUpdate.php?id=$user_data[id]' title='Visualizar'>
...
<script>
    ...
    function searchData()
    {
        window.location = 'nfCancelamento.php?search='+search.value;
    }
</script>
</html>