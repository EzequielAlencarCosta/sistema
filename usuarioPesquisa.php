...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <br>
    <div class="d-flex">
            <a href="usuarioCadastro.php" class="button">+Usuario</a>
        </div>
        <br>
    <div class="m-5">
                ...
                <?php
                    while($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        <a class='btn btn-sm btn-primary' href='usuarioEdita.php?id=$user_data[id]' title='Editar'>
                            ...
                            <a class='btn btn-sm btn-danger' href='usuarioDeleta.php?id=$user_data[id]' title='Deletar'>
...
<script>
    ...
    function searchData()
    {
        window.location = 'usuarioPesquisa.php?search='+search.value;
    }
</script>
</html>