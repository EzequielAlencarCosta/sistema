...
<div class="d-flex">
        ...
        <br>
    <div class="box">
        <form action="crSaveEdit.php" method="POST">
            <fieldset>
                ...
                <div class="inputBox">
                    ...
                    <label for="codpagamento" class="labelInput">codpagamento</label>
                </div>
                <br><br>
                <div class="inputBox">
                ...
                <br><br>
                <label for="dt_recebimento"><b>Data de dt_recebimento:</b></label>
