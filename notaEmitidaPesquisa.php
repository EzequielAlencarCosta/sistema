<?php
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM nota_fiscal WHERE id LIKE '%$data%' OR cliente_nome LIKE '%$data%' AND  status_nf='E' ORDER BY id DESC";

    }
    else
    {
        $sql = "SELECT * FROM nota_fiscal WHERE status_nf='E' ORDER BY id DESC";
    }
...
<body>
    ...
    <br>
    <?php
        echo "<h4> NOTAS FISCAIS EMITIDAS </h4>
            ...
            <tbody>
                <?php
                    while($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>
                        <a class='btn btn-sm btn-primary' href='notaDetalhes.php?id=$user_data[id]' title='Visualizar'>
...
<script>
    ...
    function searchData()
    {
        window.location = 'notaEmitidaPesquisa.php?search='+search.value;
    }
</script>
</html>