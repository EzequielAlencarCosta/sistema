<?php
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM nota_fiscal WHERE id LIKE '%$data%' OR cliente_nome LIKE '%$data%' AND  status_nf='C' ORDER BY id DESC";

    }
    else
    {
        $sql = "SELECT * FROM nota_fiscal WHERE status_nf='C' ORDER BY id DESC";
    }
...
<body>
    ...
    <br>
    <?php
        echo "<h4> NOTAS FISCAIS CANCELADAS </h4>
            ...
            <tbody>
                <?php
                    while($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>".$user_data['cliente_endereco']."</td>";
                        echo "<td>".$user_data['cliente_cpf']."</td>";
                        echo "<td>".$user_data['valor_total']."</td>";
                        echo "<td>".$user_data['status_nf']."</td>";
                        echo "<td>
                        <a class='btn btn-sm btn-primary' href='notaCanceladaDetalhes.php?id=$user_data[id]' title='Visualizar'>
...
<script>
    ...
    function searchData()
    {
        window.location = 'notaCanceladaPesquisa.php?search='+search.value;
    }
</script>
</html>