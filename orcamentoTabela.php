...
if (isset($_POST["finalizar_pedido"])) {
    ...
    if ($result_calculate_total->num_rows > 0) {
        ...
        $sql_update_pedido = "UPDATE pedidos SET total = '$total_pedido', status='O',id_funcionario='$id_funcionario',data_pedido = '$horaFormatada' WHERE id = '$pedido_id'";
...
<form action="" method="post" class=buttonFinaliza >
    <button type="submit" name="finalizar_pedido">Finalizar Orçamento</button>
...
<form action="" method="post">
    ...
    <button type="submit">Adicionar ao oraçamento</button>
    </form>
<br>
<!-- Lista de itens no pedido -->
<h2>Orçamento Número: <?php print_r($pedido_id)?></h2>
<div class="m-5" >
<table class="table text-white table-bg">
    <tr>
        <th>Produto</th>
