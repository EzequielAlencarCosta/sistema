<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao, "INSERT INTO contaspagar(descricao,codbarras,valor,vencimento,formapgto) 
        VALUES ('$descricao','$codbarras','$valor','$vencimento','$formapgto')");
...
<body>
    ...
    <div class="box">
        <form action="cpCadastro.php" method="POST">
            <fieldset>
                <legend><b>Cadastro contas a pagar</b></legend>
                <br><br><br>
                <div class="inputbox">
               ...
               <br>
                <div class="inputbox">
                    <input type="text" name="codbarras" id="codbarras" class="inputUser" required>
                    <label for="codbarras" class="labelInput">Codifo de barras</label>
                </div>
