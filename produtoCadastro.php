<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $id_receita = $_POST['id_recceita'];
        $preco = $_POST['preco'];
        
        $result = mysqli_query($conexao, "INSERT INTO produtos(produto,quantidade,data_validade,id_receita,preco) 
        VALUES ('$produto','$quantidade','$data_validade','$id_receita','$preco')");
...
<body>
    ...
    <div class="box">
        <form action="produtoCadastro.php" method="POST">
            <fieldset>
                <legend><b>Cadastro Produtos</b></legend>
                <br><br><br>
                <div class="inputbox">
               ...
               <br>
                ...
                <br><br>
                <div class="inputbox">
                    <input type="text" name="id_recceita" id="id_receita" class="inputUser" required>
                    <label for="id_recceita" class="labelInput">Id Receita</label>
                </div>
                ...
                <input type="date" name="data_validade" id="data_validade" value="<?php echo date('Y-m-d'); ?>" required>
                <br><br>
                <br><br><br>        
