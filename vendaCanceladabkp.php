<?php
    ...
    {
        $sql = "SELECT * FROM pedidos where status='C' ORDER BY id DESC";
    }
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="principal.php">SISTEMA DE VENDAS</a>
            ...
            <tbody>
                <?php
                    while($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>".$user_data['endereco_entrega']."</td>";
                        echo "<td>".$user_data['status']."</td>";
                        echo "<td>".$user_data['total']."</td>";
                        echo "<td>
                        <a class='btn btn-sm btn-primary' href='vendacanceladaDetalhe.php?id=$user_data[id]' title='Visualizar'>
...
<script>
    ...
    function searchData()
    {
        window.location = 'vendaCancelada.php?search='+search.value;
    }
</script>
</html>